...
switch ($lang) {
    case 'ru-ru':
        $location = "//mgdru.oasgames.com/events/2/ru/{$platform}/";
        break;
    case 'de-de':
        $location = "//mgdde.oasgames.com/events/2/de/{$platform}/";
        break;
    case 'fr-fr':
        $location = "//mgdfr.oasgames.com/events/2/fr/{$platform}/";
        break;
    default:
        $location = "//mgden.oasgames.com/events/2/en/{$platform}/";
        break;
}
